...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema sagrave_ouchy
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `sagrave_ouchy` ;

-- -----------------------------------------------------
-- Schema sagrave_ouchy
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sagrave_ouchy` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `sagrave_ouchy` ;

-- -----------------------------------------------------
-- Table `sagrave_ouchy`.`carburant`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sagrave_ouchy`.`carburant` ;

CREATE TABLE IF NOT EXISTS `sagrave_ouchy`.`carburant` (
  `id` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `sagrave_ouchy`.`t_cards`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sagrave_ouchy`.`t_cards` ;

CREATE TABLE IF NOT EXISTS `sagrave_ouchy`.`t_cards` (
...
CREATE UNIQUE INDEX `id_UNIQUE` ON `sagrave_ouchy`.`t_cards` (`id` ASC) VISIBLE;


-- -----------------------------------------------------
-- Table `sagrave_ouchy`.`t_tankdaten`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sagrave_ouchy`.`t_tankdaten` ;

CREATE TABLE IF NOT EXISTS `sagrave_ouchy`.`t_tankdaten` (
...
CREATE UNIQUE INDEX `M27_UNIQUE` ON `sagrave_ouchy`.`t_tankdaten` (`M27` ASC) VISIBLE;

USE `sagrave_ouchy` ;

-- -----------------------------------------------------
-- function calcul_total_card
-- -----------------------------------------------------
